...
#SBATCH -o pat.out        # 打印输出的文件

conda activate attack                # 激活的虚拟环境名称
# 运行代码
 python adv_train.py --batch_size 128 --arch resnet50 --dataset cifar --attack "FastLagrangePerceptualAttack(model, bound=0.5, num_iterations=7)" --only_attack_correct --dataset_path ~/data --eps 1.0
